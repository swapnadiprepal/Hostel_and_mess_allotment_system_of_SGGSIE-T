...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="home_manager.php">SGGS HOSTEL <span class="display"></span></a></h1>
				...
				<li class="next-slide">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-2)" xlink:href="web_home/images/3.png"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand"  href="https://sggs.ac.in/home/page/Hostel-Facility" target="_blank"> SGGS <span class="display"> SGGS HOSTEL </span></a>
		</div>
