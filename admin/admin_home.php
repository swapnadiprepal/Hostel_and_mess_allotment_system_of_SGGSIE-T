...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="admin_home.php">SGGS HOSTEL<span class="display"></span></a></h1>
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<!-- <image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="..web_home\images\j1.jpg"></image> -->
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="../web_home/images/j1.jpg"></image>
